...
export class initialMigration1696034387271 implements MigrationInterface {
  name = 'initialMigration1696034387271';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE \`brand\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updateAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`removeAt\` datetime(6) NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, \`name\` varchar(255) NOT NULL, \`description\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`payment\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updateAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`removeAt\` datetime(6) NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, \`date\` varchar(255) NOT NULL, \`amount\` int NOT NULL, \`creditId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`payment_date\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updateAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`removeAt\` datetime(6) NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, \`amount\` int NOT NULL, \`date\` varchar(255) NOT NULL, \`creditId\` int NULL, \`paymentId\` int NULL, UNIQUE INDEX \`REL_db24887aaf7871047c1858c964\` (\`paymentId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`percent\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updateAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`removeAt\` datetime(6) NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, \`fee\` int NOT NULL, \`rate\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`credit\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updateAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`removeAt\` datetime(6) NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, \`fee\` int NOT NULL, \`rate\` int NOT NULL, \`comment\` varchar(255) NOT NULL DEFAULT '', \`isExonerated\` tinyint NOT NULL DEFAULT 0, \`orderId\` int NULL, \`percentId\` int NULL, UNIQUE INDEX \`REL_1419df244809aa35d63a91c642\` (\`orderId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`role\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updateAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`removeAt\` datetime(6) NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, \`name\` varchar(255) NOT NULL DEFAULT 'user', PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`user\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updateAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`removeAt\` datetime(6) NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, \`user_id\` varchar(255) NOT NULL, \`email\` varchar(255) NULL, \`password\` varchar(255) NOT NULL, \`webToken\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`member\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updateAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`removeAt\` datetime(6) NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, \`avatar\` varchar(255) NULL, \`userId\` int NULL, \`personId\` int NULL, UNIQUE INDEX \`REL_08897b166dee565859b7fb2fcc\` (\`userId\`), UNIQUE INDEX \`REL_32b5c701c2e416b6d60f294385\` (\`personId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`person\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updateAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`removeAt\` datetime(6) NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, \`nickName\` varchar(255) NULL, \`firstName\` varchar(255) NULL, \`lastName\` varchar(255) NULL, \`phone\` varchar(255) NULL, \`address\` varchar(255) NULL, \`identification\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`customer\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updateAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`removeAt\` datetime(6) NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, \`avatar\` varchar(255) NULL, \`status\` varchar(255) NULL, \`position\` int NOT NULL DEFAULT '1', \`limit\` int NOT NULL DEFAULT '0', \`personId\` int NULL, UNIQUE INDEX \`REL_b48cc61c6aa50b58eb2522ee40\` (\`personId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`order\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updateAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`removeAt\` datetime(6) NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, \`isAnulated\` tinyint NOT NULL, \`isCompleted\` tinyint NOT NULL, \`comment\` varchar(255) NULL, \`customerId\` int NULL, \`memberId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`variant\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updateAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`removeAt\` datetime(6) NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, \`code\` varchar(255) NULL, \`name\` varchar(255) NOT NULL, \`description\` varchar(255) NULL, \`price\` int NOT NULL, \`priceCredit\` int NOT NULL, \`cost\` int NOT NULL, \`stock\` int NOT NULL, \`position\` int NOT NULL DEFAULT '0', \`isPublished\` tinyint NOT NULL DEFAULT 0, \`productId\` int NULL, UNIQUE INDEX \`IDX_d5ae5f80324192e95876cf478f\` (\`code\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`order_detail\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updateAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`removeAt\` datetime(6) NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, \`price\` int NOT NULL, \`cost\` int NOT NULL, \`amount\` int NOT NULL, \`orderId\` int NULL, \`productId\` int NULL, \`variantId\` int NULL, UNIQUE INDEX \`REL_a3647bd11aed3cf968c9ce9b83\` (\`productId\`), UNIQUE INDEX \`REL_9593cc3b6ec5accb6a98bcfd14\` (\`variantId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`section\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updateAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`removeAt\` datetime(6) NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, \`name\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`sub_category\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updateAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`removeAt\` datetime(6) NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, \`name\` varchar(255) NOT NULL, \`description\` varchar(255) NULL, \`position\` int NOT NULL DEFAULT '0', \`imageId\` int NULL, \`bannerId\` int NULL, \`categoryId\` int NULL, UNIQUE INDEX \`REL_7a4ff16fa3e081b0fb532ffa05\` (\`imageId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`product\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updateAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`removeAt\` datetime(6) NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, \`code\` varchar(255) NOT NULL, \`description\` varchar(255) NULL, \`price\` int NOT NULL, \`priceCredit\` int NOT NULL, \`cost\` int NOT NULL, \`stock\` int NOT NULL, \`position\` int NOT NULL DEFAULT '0', \`isPublished\` tinyint NOT NULL DEFAULT 0, \`subCategoryId\` int NULL, \`brandId\` int NULL, \`sectionId\` int NULL, \`bannerId\` int NULL, UNIQUE INDEX \`IDX_99c39b067cfa73c783f0fc49a6\` (\`code\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`image\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updateAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`removeAt\` datetime(6) NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, \`url\` varchar(255) NOT NULL, \`productId\` int NULL, \`variantId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`category\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updateAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`removeAt\` datetime(6) NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, \`name\` varchar(50) NOT NULL, \`description\` varchar(255) NULL, \`position\` int NOT NULL DEFAULT '0', \`imageId\` int NULL, \`bannerId\` int NULL, UNIQUE INDEX \`REL_8a12e4cb68bc526f8d8e59efb1\` (\`imageId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`banner\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updateAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`removeAt\` datetime(6) NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, \`name\` varchar(255) NOT NULL, \`description\` varchar(255) NULL, \`imageId\` int NULL, UNIQUE INDEX \`REL_6a6cc2453a0675d3e2cad3070c\` (\`imageId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX \`REL_9593cc3b6ec5accb6a98bcfd14\` ON \`order_detail\``,
    );
    await queryRunner.query(
